...
//1406122/1482531/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS725LLCTR-05AB-T" (originalName "ACS725LLCTR-05AB-T")
	...
	(compDef "ACS725LLCTR-05AB-T" (originalName "ACS725LLCTR-05AB-T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS725LLCTR-05AB-T"))
		...
		(attr "Mouser Part Number" "250-725LLCTR05ABT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS725LLCTR-05AB-T?qs=pUKx8fyJudD0gM9RcXk04g%3D%3D")
		(attr "Manufacturer_Name" "Allegro Microsystems")
		(attr "Manufacturer_Part_Number" "ACS725LLCTR-05AB-T")
		(attr "Description" "High-Accuracy, 3.3V Isolated Current Sensor with Stray Field Rejection")
		(attr "<Hyperlink>" "https://www.allegromicro.com/-/media/files/datasheets/acs725-datasheet.ashx")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ACS725LLCTR-05AB-T.stp")
